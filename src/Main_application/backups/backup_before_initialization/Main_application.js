...
export default function MainApplication() {
    ...
    const renderModels = (models) => {
        return models.split(',').map((model, idx) => (
            <div
                className='modelm_container model-background'
                key={idx}
            >
                <span>{model}</span>
            </div>
                    ...
                    <table className="Main_application">
                        ...
                        <tbody>
                            {filteredData.map((item, index) => (
                                <tr key={index} onClick={() => handleRowClick(item.MaterialCode)}>
                                    <td>{item.id}</td>
                                    <td>
                                    ...
                                    <td className='main_application-width'>{item.materialDescription}</td>
                                    <td>
                                        {uploadedImages[item.MaterialCode] ? (
                                            <div className='main-application-image'>
                                                <img src={uploadedImages[item.MaterialCode]} alt="Material" className='image_size' />
                                                <div className='zoom-icon-container' onClick={() => handleZoom(uploadedImages[item.MaterialCode])}>
