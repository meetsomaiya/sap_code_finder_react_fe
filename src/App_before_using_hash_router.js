...
// import Heartbeat from './Main_application/HeartBeat'; // Adjust the path if necessary

import LoginForm from './login/Loginform_sap';
...
import Homecontainer from './Homepage/Homecontainetr'
      ...
      <HashRouter>
          ...
          {/* <Navbarr /> */}
              ...
              <Routes>
                ...
                <Route path="/User_management/User_management" element={<User_manegement />} />
                <Route path="/Admin_manegement/Admin_manegement" element={<Admin_manegement />} />
                ...
                <Route path="/Main_application/Main_application" element={<Main_application />} />
                {/* <Heartbeat />  */}
                ...
                <Route path="/Homepage/Homecontainetr" element={<Homecontainer />} />

                <Route path="*" element={<LoginForm />} /> {/* This route will match any other paths */}
